...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        switchDevMode.isChecked = sharedPref.getBoolean("DEV_MODE", false)
    ...
    override fun onResume() {
        super.onResume()
        fetchFromLocal() // Always refresh from local DB when coming back
        refreshAllData()
    ...
    private fun fetchFromLocal() {
        thread {
            try {
                ...
                Log.e("HOME_DEBUG", "Local fetch error", e)
            }
        }
    }
