...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        ...
        const val COLUMN_MEAS_HIP = "hip"
        const val COLUMN_MEAS_RISE = "rise"
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        val createMeasurementsTable = ("CREATE TABLE IF NOT EXISTS $TABLE_MEASUREMENTS (" +
                ...
                "$COLUMN_MEAS_HIP TEXT, " +
                "$COLUMN_MEAS_RISE TEXT, " +
    ...
    // --- MEASUREMENT METHODS ---
    fun addMeasurement(customerId: Int, type: String, length: String, chest: String, waist: String, collar: String, shoulder: String, sleeve: String, hip: String, rise: String, notes: String, status: String): Long {
        val db = this.writableDatabase
        val values = ContentValues().apply {
            ...
            put(COLUMN_MEAS_HIP, hip)
            put(COLUMN_MEAS_RISE, rise)
    ...
    fun updateMeasurement(id: Int, length: String, chest: String, waist: String, collar: String, shoulder: String, sleeve: String, hip: String, rise: String, notes: String, status: String): Int {
        val db = this.writableDatabase
        val values = ContentValues().apply {
            put(COLUMN_MEAS_LENGTH, length)
            put(COLUMN_MEAS_CHEST, chest)
